  ...
  return (
    <div className="mt-12">
      ...
      dark:bg-secondary-dark-bg
        ...
        bg-hero-pattern bg-no-repeat bg bg-cover
        bg-center
        "
        >
          <div
          ...
          >
            <div>
              ...
              <p className="text-2xl">$65,949.78</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
            ...
            <div className="border-r-1- border-color m-4 pr-10">
              <div>
                <p >
                  ...
                  font-semibold">$98,264</span>
                  <span className="p-1.5 
                  hover:drop-shadow-xl
                  cursor-pointer 
                  rounded-full bg-green-400 ml-3
                  text-xs">35%</span>
                </p>
